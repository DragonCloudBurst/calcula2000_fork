...
function init_calcula2000(){
	...
	//arrays
	//frog inspired names
	var arr_character_names = ["Abs", "Agnus", "Al-gea", "Amphibulus", "Scrubby", "Crusty", "Bouncer", "Bouncy", "Blinky", "Booboo the Bloatoad", "Bobo", "Booboo", "Bob", "Boo", "Boogy", "Bubba", 
				   "Bubble", "Buds", "Buddy", "Buggy", "Bumpy", "Chicky", "Chops", "Chubby", "Fats", "Fatso", "Chubber", "Flubber", "Chubbs", "Chunk", "Chunky", "Chunko", "Copper", "Conan", "Cool Frog",
				   "Croaker", "Croaks", "Croaky", "Crunchy", "Cups", "Curmet", "Kermits", "Darty", "Dars", "Doc", "Dots", "Frogzilla", "Peppers", "Ducky", "Ducks", "Dumbell", "Dumpy", "Dumby", "Edgar",
				   "Mimi", "Fatso", "Fatty", "Fatter Frog", "Fattest", "Fattest Frog", "Fatty Arbuckles", "Fearless Froglet", "Fergie", "Fibby", "Fiddles", "Fillmore", "Filbert", "Ferdinand", "Figaro",
				   "Flibbit", "Flips", "Floatie", "Flubbers", "Francis", "Freaky Frog", "Freaky", "Froggens", "Froggins", "Froglestew", "Freckle", "Fugie", "Glossy", "Gobble", "Gobbles", "Gomez", "Gooey",
				   "Gordon", "Gorf", "Gorf", "Gordito", "Greenie", "Gregan", "Grinner", "Grog", "Guacamole", "Guacky", "Gub-gub", "Gumball", "Gus", "Gus Gus", "Hogie", "Hoogie", "Hoogy", "Howie",
				   "Hecktor", "Gerby", "Herby", "Hippyfrog", "Hopkins", "Hopper", "Hoppy", "Hoppity", "Hoppity-Hop", "Hop-Hop", "Hopps-alot", "Hopson", "Hopston", "Hot Frog", "Hot-Toad", "Hugo-a-go-go",
				   "Hugo", "Ichabod", "Iggy", "Ivan", "Jabba", "Jabba the Jumpy", "Jumpy", "Jeremiah", "Jimmy da toad", "Joey", "Jorg", "Yurg", "Jumpiter", "Kermit", "Kermit Klein", "Ketchup", "Kilroy",
				   "Kirby", "King Kirby", "Klack", "Kokomo", "Krebbit", "Kroppy", "Leaper", "Leapy", "Leafy", "Legs", "Leroy", "Little Guy", "Leggy", "Louie", "Lumpy", "Lumps", "Man-o Frog", "Marina",
				   "Mark McGwire", "Max", "Maxter", "Mermin", "Merms", "Germs", "Mr.Croak", "Mr. Frog", "Mr. Fribble", "Mr. Skinny", "Mr. Mouth", "Mister Mac", "Mr. Red Bottom", "Mr. Moco", "Mog", "Moe Moe",
				   "Munky", "Murdock", "Nanotoad", "Noodles", "Nozy", "Frogy-Wan", "Patches", "Peabody", "Peanut", "Peeps", "Squeeks", "Pekkle", "Pickles", "Pickle", "Floyd", "Pip", "Phyto-P", "Plop",
				   "Plopps", "Po", "Poegy", "Pogo", "Pookee", "Crackers", "Popcorn", "Prince Soggy Bottom", "Puddles", "Pug Pug", "Punkins", "Pudgetta", "Quigley", "Quiggle", "Quibbit", "Quigleys", "Quiggles",
				   "Giggles", "Quiglly", "Raisin", "Ruperts", "Crumbs", "Shamrockfrog", "Sir Croaks alot", "Skippy", "Skippydippy", "Skittles", "Slappy", "Slims", "Slimmy", "Slinky", "Slippy", "Slick", "Slub",
				   "Sluggs", "Sluggo", "Soupy", "Smeaglet", "Smiles", "Smiley", "Springer", "Sprocket", "Sprog", "Sproing", "Spud", "Spuds", "Squiggly", "Squirt", "Sticky", "Stinky", "Stomper", "Stone Cold",
				   "Stoney", "Stubby", "Stumper", "Stud", "Studs", "Squishy", "Squeeky", "Squirmy", "Squirms", "Tater", "Tomato", "Taters", "Tamoto", "El Tamoto", "Tapioca", "Tiggle", "Tiggles", "Tibbir",
				   "Ribbits", "Tommy the Toad", "Tricky", "Tubby", "Tubs", "Tuffy", "Twiggles", "Watermelonbaby", "Webby", "Webs", "Wet Willy", "Wembley", "Wiggles", "Giggles", "Winky", "Wiggletins",
				   "Whopper", "Xorcon", "Yggorf", "Zenon", "Zippity", "Zippy", "Zips", "Zookey", "Zucchini"];
	//random output
	var arr_text_calculator_output = ["You're a match!", "It's a match!", "It's a match!", "Perfect match!", "Yes!", "Soul mate!", "It's a boy!", "It's a girl!", "It's a tie!", "Soulmate!", "No good.", "It looks bad.",
					  "Looks bad.", "Looks good!", "It looks good.", "No!", "Perfect match!", "You're a match!", "Tie!", "I don't know.", "I have no idea.", "I honestly don't know.", "I have no clue.",
					  "No clue.", "No idea.", "I do not know.", "No idea.", "Math is hard.", "Math is too hard.", "Maybe not.", "Sorry I don't know.", "I have no idea.", "Out of service.", "We don't know.",
					  "No clue!", "Nope.", "No reply.", "Perfect match!", "Perfect match.", "Force quit!!"];
	
	//audio
	var arr_snd_calculator_click = ["AUD_CALCULATOR_CLICK_01.mp3", "AUD_CALCULATOR_CLICK_02.mp3", "AUD_CALCULATOR_CLICK_03.mp3", "AUD_CALCULATOR_CLICK_04.mp3", "AUD_CALCULATOR_CLICK_05.mp3",
					"AUD_CALCULATOR_CLICK_06.mp3", "AUD_CALCULATOR_CLICK_07.mp3", "AUD_CALCULATOR_CLICK_08.mp3", "AUD_CALCULATOR_CLICK_09.mp3", "AUD_CALCULATOR_CLICK_10.mp3",
					"AUD_CALCULATOR_CLICK_11.mp3", "AUD_CALCULATOR_CLICK_12.mp3", "AUD_CALCULATOR_CLICK_13.mp3", "AUD_CALCULATOR_CLICK_14.mp3", "AUD_CALCULATOR_CLICK_15.mp3",
					"AUD_CALCULATOR_CLICK_16.mp3", "AUD_CALCULATOR_CLICK_17.mp3", "AUD_CALCULATOR_CLICK_18.mp3", "AUD_CALCULATOR_CLICK_19.mp3", "AUD_CALCULATOR_CLICK_20.mp3",
					"AUD_CALCULATOR_CLICK_21.mp3", "AUD_CALCULATOR_CLICK_22.mp3", "AUD_CALCULATOR_CLICK_23.mp3", "AUD_CALCULATOR_CLICK_24.mp3", "AUD_CALCULATOR_CLICK_25.mp3",
					"AUD_CALCULATOR_CLICK_26.mp3", "AUD_CALCULATOR_CLICK_27.mp3", "AUD_CALCULATOR_CLICK_28.mp3", "AUD_CALCULATOR_CLICK_29.mp3", "AUD_CALCULATOR_CLICK_30.mp3",
					"AUD_CALCULATOR_CLICK_31.mp3", "AUD_CALCULATOR_CLICK_32.mp3", "AUD_CALCULATOR_CLICK_33.mp3"];
